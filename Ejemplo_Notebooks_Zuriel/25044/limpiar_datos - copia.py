...
def generar_concentrados_mensuales(directorio_salida, directorio_concentrado):
    os.makedirs(directorio_concentrado, exist_ok=True)
    archivos_csv = [os.path.join(directorio_salida, f) for f in os.listdir(directorio_salida) if f.endswith(".csv")]
